...
import SheetModeGrid, { CellParameters } from "@/components/sheet-mode-grid";
...
function ExcelCellDetailsPanel({ 
  ...
  return (
    <div className={`fixed right-4 top-20 w-80 bg-white border border-gray-300 rounded-lg shadow-lg z-50 ${
      isVisible ? 'block' : 'hidden'
    }`}>
      <div className="bg-gray-100 px-4 py-2 border-b border-gray-300 flex items-center justify-between">
        <h3 className="text-sm font-bold text-gray-700">セル詳細: {selectedCell}</h3>
        <button 
          onClick={onClose}
          ...
          <div className="space-y-2">
            <div>
              ...
              <input 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, value: e.target.value})}
            ...
            <div>
              ...
              <input 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, formula: e.target.value})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
            ...
            <div>
              ...
              <select 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, dataType: e.target.value})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
              >
                <option>テキスト</option>
                <option>数値</option>
          ...
          <div className="space-y-2">
            <div>
              ...
              <select 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, format: e.target.value})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
              >
                <option>標準</option>
                <option>数値</option>
            ...
            <div>
              ...
              <select 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, fontFamily: e.target.value})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
              >
            ...
            <div>
              ...
              <select 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, fontSize: parseInt(e.target.value)})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
              >
                <option>8</option>
                <option>9</option>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <input 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, isBold: e.target.checked})}
                className="text-xs"
              />
            ...
            <div className="flex items-center gap-2">
              <input 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, isItalic: e.target.checked})}
                className="text-xs"
              />
            ...
            <div className="flex items-center gap-2">
              <input 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, isUnderline: e.target.checked})}
                className="text-xs"
              />
            ...
            <div>
              ...
              <select 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, textAlign: e.target.value})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
              >
          ...
          <div className="space-y-2">
            <div>
              ...
              <input 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, backgroundColor: e.target.value})}
            ...
            <div>
              ...
              <input 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, textColor: e.target.value})}
                className="w-full h-8 border border-gray-300 rounded"
              />
            </div>
            <div>
              ...
              <select 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, borderStyle: e.target.value})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
              >
                <option>なし</option>
                <option>細線</option>
          ...
          <div className="space-y-2">
            <div>
              ...
              <input 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, validation: e.target.value})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
            ...
            <div>
              ...
              <textarea 
                ...
                onChange={(e) => onCellParamsChange({...cellParams, comment: e.target.value})}
                className="w-full px-2 py-1 text-xs border border-gray-300 rounded"
                rows={2}
...
// Excel風の追加機能コンポーネント
function ExcelToolbar({ onShowCellDetails }: { onShowCellDetails: () => void }) {
  ...
  return (
    <div className="bg-gray-100 border-b border-gray-300 p-2 flex items-center gap-2">
      ...
      <div className="flex-1 flex items-center gap-2">
        <span className="text-xs font-bold text-gray-600 min-w-[40px]">{selectedCell}</span>
        <input 
          type="text" 
          value={formula}
        ...
        {sheets.map((sheet, index) => (
          <button
            ...
            className={`px-4 py-2 text-sm border-r border-gray-300 hover:bg-gray-100 ${
              activeSheet === sheet ? 'bg-white border-b-2 border-b-white' : 'bg-gray-200'
            }`}
          >
            {sheet}
          </button>
...
function ExcelMenuBar() {
  ...
  return (
    <div className="bg-gray-100 border-b border-gray-300 p-1 flex items-center gap-4 text-xs">
      <div className="flex items-center gap-4">
        <button 
          onClick={() => setActiveMenu(activeMenu === "ファイル" ? "" : "ファイル")}
        ...
        <button 
          onClick={() => setActiveMenu(activeMenu === "ページレイアウト" ? "" : "ページレイアウト")}
          className={`px-2 py-1 rounded hover:bg-gray-200 ${
...
export default function ExcelSurveyUI() {
  ...
  const [selectedCellParams, setSelectedCellParams] = React.useState<CellParameters>({
    value: "",
    formula: "",
    format: "標準",
    fontFamily: "Segoe UI",
  ...
  // セル選択時の処理
  const handleCellSelect = (cellParams: CellParameters, rowIndex: number, colIndex: number) => {
  ...
  // セルパラメータ更新時の処理
  const handleCellUpdate = (cellParams: CellParameters, rowIndex: number, colIndex: number) => {
    setSelectedCellParams(cellParams);
  };
